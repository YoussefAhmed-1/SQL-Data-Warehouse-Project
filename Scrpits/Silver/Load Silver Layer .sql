...
--************************** Loading silver..crm_sales_details **************************
		...
		sls_prd_key,
		sls_cust_id,
		-- Convert order, ship, and due date from YYYYMMDD integer format to DATE,
		-- while handling invalid or incorrectly formatted dates by returning NULL.
...
--************************** Loading silver.erp_cust_az12 **************************
		...
		SELECT 
		-- Clean and standardize customer IDs by removing the 'NAS' prefix when present.
